...
const content = String.raw`import 'package:ai_memory_coach/features/coins/domain/entities/coin_wallet.dart';
...
List<Override> _overrides(MyRoomState room) {
  return [
    myRoomControllerProvider.overrideWith((ref) => _FakeRoomController(ref, room)),
...
void main() {
  testWidgets('room editor renders game-like default room and compact controls', (
    tester,
  ) async {
    ...
    expect(find.text('창문'), findsWidgets);
