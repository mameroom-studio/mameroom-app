...
class _RoomMetrics {
  ...
  static _RoomMetrics from(BoxConstraints constraints) {
    ...
    final roomHeight = (height * (dense ? 0.41 : 0.43)).clamp(300.0, 382.0);
    return _RoomMetrics(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            return Stack(
              ...
              children: [
                Positioned.fill(child: CustomPaint(painter: _RoomPainter(colors))),
                Positioned(
                  left: width * 0.49,
                  bottom: height * 0.13,
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Icon(_iconFor(layout.item.itemType), color: itemColor, size: 21),
...
class _EditToolbar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Expanded(child: _ToolbarButton(icon: Icons.open_with_rounded, label: '이동', onTap: onMove)),
          Expanded(child: _ToolbarButton(icon: Icons.rotate_right_rounded, label: '회전', onTap: onRotate)),
          Expanded(child: _ToolbarButton(icon: Icons.inventory_2_outlined, label: '보관', onTap: onStore)),
          Expanded(child: _ToolbarButton(icon: Icons.delete_outline_rounded, label: '삭제', onTap: onDelete)),
          Expanded(child: _ToolbarButton(icon: Icons.check_rounded, label: '완료', onTap: onDone, primary: true)),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: primary ? colors.primary : colors.primaryMist.withValues(alpha: 0.32),
            borderRadius: BorderRadius.circular(12),
          ),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(icon, size: 18, color: primary ? Colors.white : colors.primary),
  ...
  Widget build(BuildContext context) {
    ...
    return Tooltip(
      ...
      child: AnimatedContainer(
        key: ValueKey('room-sprite-\${item.id}'),
...
class _RoomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRect(
      Rect.fromLTWH(size.width * 0.23, size.height * 0.13, size.width * 0.2, size.height * 0.18),
      accent,
    );
    canvas.drawLine(
...
const _defaultLayouts = [
  UserRoomLayout(id: 'layout-default-bed', item: _defaultBed, positionX: 0.18, positionY: 0.56),
  UserRoomLayout(id: 'layout-default-desk', item: _defaultDesk, positionX: 0.76, positionY: 0.56),
  UserRoomLayout(id: 'layout-default-chair', item: _defaultChair, positionX: 0.66, positionY: 0.67),
  UserRoomLayout(id: 'layout-default-rug', item: _defaultRug, positionX: 0.45, positionY: 0.78),
  UserRoomLayout(id: 'layout-default-window', item: _defaultWindow, positionX: 0.33, positionY: 0.24),
  UserRoomLayout(id: 'layout-default-plant', item: _defaultPlant, positionX: 0.10, positionY: 0.36),
  UserRoomLayout(id: 'layout-default-shelf', item: _defaultShelf, positionX: 0.89, positionY: 0.40),
];
`;
